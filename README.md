...
**他社へ共有する場合**は、同梱の **`導入マニュアル.md`** を一緒に渡してください。インストール手順と使い方が記載されています。

**Chrome Web Store に公開せずGitHubリンクで配布する場合**は、同梱の **`配布・受け取り設定マニュアル.md`** を確認してください。GitHubからZIPをダウンロードし、受け取り側でChromeに読み込む手順をまとめています。
...
├── DESIGN.md           # 設計書
├── 配布・受け取り設定マニュアル.md # GitHubリンク受け取り手順
└── README.md
```
